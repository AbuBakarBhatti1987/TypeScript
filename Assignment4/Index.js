...
let message1 = 2; //It's returning an error, as the variable "message" can either be a number or a string, but it can not be both. So, I have changed variable name to "message1" to avoid this error here.
...
let score = 25; // Use conditionals to assign and print grades A, B, C, D, or F.
if (score >= 90) {
    console.log("A Grade");
}
else if (score >= 80) {
